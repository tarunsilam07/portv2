  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "lallimoyilla@gmail.com",
      link: "mailto:udayg@example.com",
    },
    {
      icon: <MapPin className="h-6 w-6 text-brand-purple" />,
      title: "Location",
      details: "Divili, Andhra Pradhesh, India",
      link: "https://maps.google.com/?q=Divili",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/MoyillaLaliteswari",
    },
    {
      icon: <Linkedin className="h-6 w-6" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/laliteswari-moyilla-2780722a8/",
    },
  ];
