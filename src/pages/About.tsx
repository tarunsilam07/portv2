          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              <div className="glass-panel h-full p-8 rounded-lg">
                <div className="w-full h-80 rounded-lg mb-8 overflow-hidden shadow-lg">
                  <img
                    src="/me.jpg"
                    alt="me"
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  , a Computer Science student specializing in Internet of
                  Things at Aditya University, Surampalem.
                </p>
                <p>
