...
const Resume = () => {
  ...
  const experience = [
    {
      ...
      description: "Worked on frontend development for web applications, collaborating with team members to enhance UI/UX and performance.",
      responsibilities: [
    ...
    },
    {
      ...
      description: "Gained practical exposure to web development technologies and tools while working on assigned modules and guided tasks.",
      responsibilities: [
  ...
  const projects = [
    {
      ...
      description: "A MERN stack-based IoT web application that monitors water quality parameters in real-time with dynamic visualizations and alerts.",
    ...
    },
    {
      ...
      description: "A full-stack social media application with user authentication, real-time features, and content sharing built using Next.js and MongoDB.",
      technologies: ["Next.js", "MongoDB", "Tailwind CSS", "TypeScript", "Framer Motion"],
    ...
    {
      title: "Blog Website",
      description: "A CRUD-based blog application allowing users to create, read, update, and delete blog posts, with secure authentication and dynamic routing.",
    ...
    {
      title: "URL Shortener",
      description: "A simple URL shortener built with Node.js and Express, allowing users to shorten and manage URLs.",
      technologies: ["Node.js", "Express.js", "MongoDB", "EJS"],
  ...
  const resumeHighlights = [
    ...
    { 
      ...
      description: "Passionate about integrating IoT devices with web applications for smart solutions", 
